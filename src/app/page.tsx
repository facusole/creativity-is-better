  ...
  return (
    <main className="[&>section]:p-24 [&>section]:grid [&>section]:place-items-center [&>*:nth-child(even)]:bg-[#191919] relative">
      <section className="h-screen w-screen relative overflow-hidden">
        ...
        <svg className="absolute w-full md:w-auto top-10 lg:top-0 lg:right-16 -rotate-12" width="1550" height="128" viewBox="0 0 1510 128" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute bottom-5 w-full md:w-auto lg:left-10 lg:bottom-12 -rotate-12" width="1550" height="128" viewBox="0 0 1510 128" fill="none" xmlns="http://www.w3.org/2000/svg">
